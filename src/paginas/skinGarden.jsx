...
import Imagen1 from '../imagen/SkinGarden/login.png'
import Imagen2 from '../imagen/SkinGarden/inicio.png'
import Imagen3 from '../imagen/SkinGarden/producto.png'
import Imagen4 from '../imagen/SkinGarden/categorias.png'
import Imagen5 from '../imagen/SkinGarden/categoria2.png'
import Imagen6 from '../imagen/SkinGarden/carrito de compras.png'
    ...
    <div className='contenido-extra'>
        ...
        <div className="contenido-del-medio">
            ...
            <div className="responsabilidades-pagina">
                ...
                <ul>
                    <li>{t("skingarden-responsabilidad-1")}</li>
                    <li>{t("skingarden-responsabilidad-2")}</li>
                    <li>{t("skingarden-responsabilidad-3")}</li>
                    <li>{t("skingarden-responsabilidad-4")}</li>
                    <li>{t("skingarden-responsabilidad-5")}</li>
                    <li>{t("skingarden-responsabilidad-6")}</li>
                </ul>
            </div>
            <div className="enlaces-pagina">
                <h2>{t("bloggox.titulo-ver")}</h2>
                <Link to="https://github.com/Yeremaia/SkinGarden" target="_blank"><FaGithub /> GitHub</Link>
            </div>
        </div>
        <div className="contenido-de-abajo">
            <p>&copy; {t("bloggox.footer")} Yeremy Peralta Baez, Jeyfferson Gomez y Yorkenis Rodríguez - 2023</p>
        </div>
    </div>
  )
}
